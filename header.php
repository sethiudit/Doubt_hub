...
<body>
    ...
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php"><span class="underlined underline-overflow">Doubt_Hub</span></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
          echo '
          <p class="text-light my-0 my-sm-0 user_name_login "> Welcome '.$_SESSION['userfirstname'].'</p>
    ...
    include 'login.php';
    include 'signup.php';
    // include 'website_issue_send.php';
    if(isset($_GET['issue_email']) && $_GET['issue_email']=="true"){
      echo "<div class='position-absolute alert alert-success alert-dismissible fade show my-0 m-4 mt-4' role='alert' style='width:400px;' >
            ...
            <strong>Thanks you!</strong>Your website issue has been recorded. we will try to fix it.!
            <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
            </div>";
    }
    else if(isset($_GET['issue_email']) && $_GET['issue_email']=="false"){
      echo "<div class='position-absolute alert alert-danger alert-dismissible fade show my-0 m-4 mt-4' role='alert' style='width:400px;'>
              ...
              <strong></strong>".$_GET['issue_email']."
              <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
            </div>";
    }
